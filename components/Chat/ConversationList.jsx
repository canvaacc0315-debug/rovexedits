...
export default function ConversationList() {
  const { conversations, selectConversation, userId, loading, isAdmin, myEditorDocId } = useChatContext();
  ...
  return (
    <div style={{ overflowY: 'auto', flex: 1, padding: '8px 0' }}>
      {conversations.map((convo, i) => {
        ...
        const unread = (convo.unreadCount?.[userId] || 0) + (isAdmin ? (convo.unreadCount?.['admin'] || 0) : 0) + ((myEditorDocId && myEditorDocId !== 'admin') ? (convo.unreadCount?.[myEditorDocId] || 0) : 0);
